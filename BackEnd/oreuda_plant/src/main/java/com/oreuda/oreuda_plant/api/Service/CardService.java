...
public class CardService {
    ...
    public String getCard(String userId, PlantDto plantDto) {
        ...
        return "<!DOCTYPE svg PUBLIC\n" +
                ...
                "    </g>\n" +
                "    <image class = \"oreu-icon\" x=\"" + barSizeAdjust + "\" y=\"120\" href=\"http://172.28.0.25:8060/" + plantName + ".gif\" height=\"26\" width=\"26\" />\n" +
                "    \n" +
                "    <text x=\"165\" y=\"165\" text-anchor=\"end\" class=\"progress " + plantName + "-subtitle\">" + curStat + " / " + maxStat + "</text>" +
                "    <image class = \"oreu-img\" x=\"195\" y=\"10\" href=\"http://172.28.0.25:8060/" + plantName + ".svg\" height=\"200\" width=\"187\" />\n" +
                "</svg>\n";
    }
}
